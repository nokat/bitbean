...
QString BitbeanUnits::description(int unit)
{
    switch(unit)
    {
    case Sprout: return QString("Sprout (1,000 BitBeans)");
    case BitB: return QString("BitBean");
    case mBitB: return QString("Milli-BitBean (1 / 1,000)");
    case uBitB: return QString("Micro-BitBean (1 / 1,000,000)");
