...
{
    resize(850, 550);
    setWindowTitle(tr("BitBean") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BitBean address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BitBean"), this);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BitBean address or malformed URI parameters."));
    }
