...
static const char qt_meta_stringdata_OverviewPage[] = {
    ...
    "modelNetworkinfo\0setNetworkinfo(ClientModel*)\0"
    "updateNetworkinfo()\0,,,,\0"
    "updatePrevious(int,int,double,int,double)\0"
    "updateDisplayUnit()\0"
...
void OverviewPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setNetworkinfo((*reinterpret_cast< ClientModel*(*)>(_a[1]))); break;
        case 3: _t->updateNetworkinfo(); break;
        case 4: _t->updatePrevious((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4])),(*reinterpret_cast< double(*)>(_a[5]))); break;
